...
if selected == "Home":
    ...
    st.write("In this project, we conducted a comprehensive analysis of data courses available on the Coursera platform. We developed a machine learning model using the K-means clustering algorithm to categorize the courses into distinct groups based on their features.
